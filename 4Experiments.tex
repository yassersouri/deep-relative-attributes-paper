...
\captionsetup[subfigure]{labelformat=empty}
    ...
    \begin{subfigure}
        ...
        \footnotesize
        \stackunder[3pt]{
            \includegraphics[width=0.75\linewidth, trim={0 0 0 1cm},clip]{saliency-new/saliency-smooth/bald-6.jpeg}
        }{Bald Head}
        \vspace{0.4cm}
    \end{subfigure}
    ...
    \begin{subfigure}
        ...
        \footnotesize
        \stackunder[3pt]{
            \includegraphics[width=0.75\linewidth, trim={0 0 0 1cm},clip]{saliency-new/saliency-smooth/smile-4.jpeg}
        }{Smile}
        \vspace{0.4cm}
    \end{subfigure}
    ...
    \begin{subfigure}
        ...
        \footnotesize
        \stackunder[3pt]{
            \includegraphics[width=0.75\linewidth, trim={0 0 0 1cm},clip]{saliency-new/saliency-smooth/eyesopen-5.jpeg}
        }{Open Eyes}
        \vspace{0.4cm}
    \end{subfigure}
    ...
    \begin{subfigure}
        ...
        \footnotesize
        \stackunder[3pt]{
            \includegraphics[width=0.75\linewidth, trim={0 0 0 1cm} ,clip]{saliency-new/saliency-smooth/goodlooking-4.jpeg}
        }{Good Looking}
    \end{subfigure}
