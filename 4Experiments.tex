...
\begin{tikzpicture}
	...
	% attr4
	\node [below=0.5cm of attr3im1] (attr4im1) {\includegraphics[width=4cm, height=3cm]{spectrum/attr4/im1.jpg}};
	...
	% attr7
	\node [below=0.5cm of attr6im1] (attr7im1) {\includegraphics[width=4cm, height=4cm]{spectrum/attr7/im1.jpg}};
...
\end{table}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Saliency Maps and Localizing the Attributes}
